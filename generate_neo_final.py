...
map_dict = {
    ...
    'न्': 139, 'न': 140, # 139 fails, will override below
    'प्': 156, 'प': 158, 'फ्': 161, 'फ': 162, 'ब्': 164, 'भ्': 165, 'भ': 167, 'म्': 169, 'म': 170,
...
for k, v in map_dict.items():
    if k == 'न्': continue # Skip, we will manually set it
...
# Overrides for missing/failing characters
content += f"  'न्': '{get_char(140)}{get_char(126)}',\n"  # न + ्
content += f"  'ब': '{get_char(164)}{get_char(64)}',\n"   # ब् + ा
