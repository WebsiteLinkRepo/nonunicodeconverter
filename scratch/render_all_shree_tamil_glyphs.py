...
font_path = '/home/samuelvictor/Downloads/Shree_0803.TTF'
...
draw.text((20, 15), f"Shree_0803.TTF Glyph Map ({len(codepoints)} characters)", fill=(0, 0, 0), font=label_font)
...
for idx, code in enumerate(codepoints):
    ...
    # Draw header with hex code and decimal/char
    hex_str = f"U+{code:04X} ({code})"
...
img.save('scratch/shree_0803_glyph_chart.png')
print("Saved glyph chart to scratch/shree_0803_glyph_chart.png")
